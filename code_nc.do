...
ttest lngdp, by (minorities) 
ttest secondary, by (minorities) 
ttest loans, by (minorities)
ttest inc_pub, by (minorities) 
ttest emp2, by (minorities) 
ttest urban, by (minorities) 
ttest agri, by (minorities) 
ttest lnrain, by (minorities)  
ttest tem,  by (minorities) 
ttest pilot,  by (minorities)
ttest air,  by (minorities)
ttest info,  by (minorities) 

*Table A20	    
ttest co2_out, by (treat) unequal //1
ttest pm25m, by (treat) unequal //1
ttest lngdp, by (treat) unequal //1
ttest secondary, by (treat)  //1
ttest loans, by (treat)   //1
ttest inc_pub, by (treat) unequal //1
ttest emp2, by (treat) unequal //1
ttest urban, by (treat) unequal //1
ttest agri, by (treat) unequal //1
ttest lnrain, by (treat) unequal //1
ttest tem, by (treat) unequal //1
ttest pilot, by (treat) unequal //1
ttest air, by (treat) unequal //1
ttest info, by (treat) unequal //1
